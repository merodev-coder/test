...
function SuccessContent() {
  ...
  return (
    <div className="max-w-md w-full text-center">
      ...
      <h2 className="text-3xl font-black text-text-primary text-text-primary mb-3">
        تم تأكيد أوردرك! 🎉
      </h2>
      ...
      <div className="glass-card rounded-3xl p-6 text-right mb-6 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-black text-text-primary text-text-primary" dir="ltr">
            {orderId}
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm text-text-muted">إجمالي الأوردر</span>
          <span className="text-sm font-black text-text-primary text-text-primary">
  ...
  return (
    <div className="min-h-screen bg-white bg-surface flex flex-col" dir="rtl">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-20 mt-14">
        <Suspense
          fallback={<div className="text-text-primary text-text-primary">جاري التحميل...</div>}
        >
          <SuccessContent />
        </Suspense>
      </main>
